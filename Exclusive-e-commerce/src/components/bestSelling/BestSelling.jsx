  ...
  return (
    <div className="mt-16 md:mt-[70px]">
      <div className="flex items-center gap-x-4">
        ...
        <p className="font-poppins font-semibold text-base text-secondary">This Month</p>
      </div>
      <div className="mt-5 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
        ...
        <Link
          to="/product"
          className="inline-block font-poppins font-medium text-base text-white bg-secondary py-3 px-8 rounded-[4px] hover:bg-primary transition duration-300 text-center"
        >
          View All
        </Link>
      </div>
